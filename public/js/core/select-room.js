var socket = io();
var userNameGlobal = localStorage.getItem('') ||null;
...
$(document).ready(function () {
    ...
    if (lastUsername == null || lastUsername === "") {
        ...
        $('#username').val(lastUsername);
         //For change Username in the future
    }
...
(function () {
        ...
        socket.on("not-enough-player", () =>{
            alertify.notify('Chưa đủ người chơi', 'error', 4, function(){}); //tối đa 4 người 
        });
        ...
        socket.on("room-members", data => {
            ...
            data.users.map(function (e) {
                $('.order-' + e.order).html(`<div class="player-info">
                    ...
                    <img src="image/414704639_872833578176389_5400456240711778101_n.jpg"> 
                    </div>
